<?php
    ...
    function getKategori(){
        $query  = "SELECT kategori.id, kategori.keterangan, kategori.created_at, COUNT(produk.id) AS jumlah FROM kategori LEFT JOIN produk ON produk.kategori_id = kategori.id GROUP BY kategori.id";
        return result($query);
    }
